...
function DishCard({ data }) {
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 p-4">
        <div className="h-full bg-gray-100 rounded-2xl">
          <Image
            ...
            height={300}
            width={300}
            src={`${process.env.STRAPI_URL || "https://strapi-sample-w3e4.onrender.com/"}${
          ...
          <div className="p-8">
            <div className="group inline-block mb-4" href="#">
              ...
              <h2>${centsToDollars(data.attributes.priceinCent)}</h2>
            </div>
 ...
 function RestaurantRoute({params}){
    ...
    //     Restaurant id {JSON.stringify(data)}
    //   </main>
    //     </>
    // );
